...
define("LAFC_ADMIN_ASSETS_URL",  JURI::root(true).'/administrator/components/com_flexicontactplus/assets/');
define("LAFC_SITE_ASSETS_URL",   JURI::root(true).'/components/com_flexicontactplus/assets/');
...
define("LAFC_FIELD_ADVANCED",12);			// user defined regular expression validation
...
define("LAFC_FIELD_ATTACHMENT",21);			// file attachment
define("LAFC_FIELD_MAXTYPE",21);			// equal to the highest currently used field type
...
define("LAFC_MAX_FILE_SIZE", 10240);			// Maximum attached file size in Kb
...
// Tooltip type
define("TOOLTIP_TIP", 0);
define("TOOLTIP_BUTTON", 1);
...
// - if fcp.css exists in <current_template>/com_flexicontactplus/assets use that one
// - if not, use the configured css in components/com_flexicontactplus/assets
//
