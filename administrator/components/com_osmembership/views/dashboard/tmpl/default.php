...
<table>
	<tr>
		<td valign="top">
			<div id="cpanel">
				<?php
					...
					$this->quickiconButton('index.php?option=com_osmembership&view=profiles', 'icon-48-profiles.png', JText::_('OSM_PROFILES'));
					$this->quickiconButton('index.php?option=com_osmembership&view=subscribers', 'icon-48-subscribers.png', JText::_('OSM_SUBSCRIBERS'));
		...
		<td valign="top" width="50%" style="padding: 0 0 0 5px">			
			<?php
