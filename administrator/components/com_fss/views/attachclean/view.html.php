...
class FsssViewAttachClean extends JViewLegacy
{
	...
	function Stats()
	{
		...
		$folders = array(
			JPATH_SITE.DS.FSS_Settings::get('attach_location').DS.'support',
			JPATH_SITE.DS.FSS_Settings::get('attach_location').DS.'thumbnail'
		);
	...
	function DeleteOrphaned()
	{
		...
		$this->countStats(JPATH_SITE.DS.FSS_Settings::get('attach_location').DS.'support', '');
