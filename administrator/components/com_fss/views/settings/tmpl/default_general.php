		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td style="width:250px;">
						<input name='email_send_smtp_username' type="text" id='email_send_smtp_username' size="40" value='<?php echo $this->settings['email_send_smtp_username'] ?>'>
					</td>
					<td>
					</td>
				</tr>
				<tr>
					...
					<td style="width:250px;">
						<input name='email_send_smtp_password' type="password" id='email_send_smtp_password' size="40" value='<?php echo $this->settings['email_send_smtp_password'] ?>'>
					</td>
					<td>
					</td>
				</tr>
	...
	-->
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td style="width:250px;">
						<input name='sticky_menus' type="hidden" id='sticky_menus' size="40" value='<?php echo $this->settings['sticky_menus'] ?>'>
						<?php
						...
						$c->id = 'sticky_menus';
						$c->value = $this->settings['sticky_menus'];
						echo $c->getInput();
						?>
					</td>
				</tr>
