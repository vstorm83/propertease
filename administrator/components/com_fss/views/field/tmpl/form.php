...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="default" id="default" size="32" maxlength="250" value="<?php echo FSS_Helper::escape($this->field->default);?>" /><br>
	...
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				...
				<b>WARNING: If you change this for an existing field, any stored data will be lost</b>
            </td>
		</tr>
		<tr>
		    <td width="135" align="right" class="key">
