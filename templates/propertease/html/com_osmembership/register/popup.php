			...
			<div class="modal-body">
				<h3>
					...
					<form method="post" action="<?php echo $actionUrl ; ?>" name="osm_login_form" id="osm_login_form" autocomplete="off" class="">
					   ...
					   <div class="form-group">
							<p>
								By logging in, you agree to our <a href="conditions-of-use.html#Privacy">Privacy Policy</a>
								and <a href="conditions-of-use.html">Terms of Use.</a>
							</p>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group last-group">
						<button class="btn btn-sbm" type="button">NEXT STEP</button>
					</div>
				</div>
			</div>
		</div>
