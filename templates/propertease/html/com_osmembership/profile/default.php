                ...
                <form action="index.php" method="post" name="osm_form" id="osm_form" autocomplete="off" enctype="multipart/form-data" class="form form-horizontal">
                    ...
                    <div class="row row-eq-height">
                        ...
                        <div class="col-lg-3">
                                <div class="inner-addon right-addon">
                                <?php
                                if (isset($fields['first_name']) && $fields['first_name']->value != '')
                                {
                                    echo "<p>".$fields['first_name']->input."</p>";
                                } else 
                                {?>
                                	<p><input type="text" size="25" class="validate[required] form-control" placeholder="First Name" id="first_name" name="first_name"></p>
                                <?php 
                                }
                                ?>
                                </div>
                                <div class="inner-addon right-addon">
                                 <?php
                                if (isset($fields['last_name']) && $fields['last_name']->value != '')
                                {
                                    echo "<p>".$fields['last_name']->input."</p>";
                                } else 
                                {
                                ?>
                                	<input type="text" class="validate[required] form-control" placeholder="Last Name" id="last_name" name="last_name">
                                <?php 
                                }
                                ?>
                                </div>
                        ...
                        <div class="col-lg-4">
                                <div class="inner-addon right-addon">
                                    ...
                                    if (isset($fields['osm_avatar']))
                                    {
										...
										$str='<div class="avatar" title="Click to Change" style="max-height:100px;overflow:hidden;" class="btn btn-primary btn-lg" data-toggle="modal"><img style="max-width:100px;" src="'.JURI::base().'media/com_osmembership/upload/'.OSMembershipHelper::getOriginalFilename($fields['osm_avatar']->value).'"/></div>';
										echo $str;
										?>
										...
										?>
                                         <div class="avatar" data-toggle="modal" style="max-height:100px;overflow:hidden;">
                    ...
                    <div class="row row-eq-height">
                       <div class="col-lg-3">
                                <div class="inner-addon right-addon">
                                <?php
                                if (isset($fields['organization']) && $fields['organization']->value != '')
                                {
                                    echo "<p>".$fields['organization']->input."</p>";
                                } else {
                                ?>
                                    <p><input type="text" placeholder="Organization" id="organization" name="organization" class="form-control"></p>
                                <?php }?>
                                </div>
                                <div class="inner-addon right-addon">
                                 <?php
                                if (isset($fields['address']) && $fields['address']->value != '')
                                {
                                    echo "<p>".$fields['address']->input."</p>";
                                } else {                                
                                ?>
                                	<p><input type="text" size="50" placeholder="Address" class="input-xlarge validate[required] form-control" id="address" name="address"></p>
                                <?php }?>
                                </div>
                        ...
                        <div class="col-lg-3">
                                <div class="inner-addon right-addon">
                                <?php
                                if (isset($fields['city']) && $fields['city']->value != '')
                                {
                                    echo "<p>".$fields['city']->input."</p>";
                                } else {
                                ?>
                                	<p><input type="text" class="validate[required] form-control" placeholder="City" id="city" name="city"></p>
                                <?php }?>
                                </div>
                                <div class="inner-addon right-addon">
                                 <?php
                                if (isset($fields['zip']) && $fields['zip']->value != '')
                                {
                                    echo "<p>".$fields['zip']->input."</p>";
                                } else {
                                ?>
                                	<p><input type="text" class="validate[required] form-control" placeholder="Zip" id="zip" name="zip"></p>
                                <?php }?>
                                </div>
                    ...
                    <div class="row row-eq-height">
                        <div class="col-lg-3">
                                <div class="inner-addon right-addon">
                                <?php
                                if (isset($fields['phone']) && $fields['phone']->value != '')
                                {
                                    echo "<p>".$fields['phone']->input."</p>";
                                } else {
                                ?>
                                	<p><input type="text" placeholder="Phone" id="phone" name="phone" class="form-control"></p>
                                <?php }?>
                                </div>                                
                        ...
                        <div class="col-lg-3">
                        		<div class="inner-addon right-addon">
                                 <?php
                                if (isset($fields['email']) && $fields['email']->value != '')
                                {
                                    echo "<p>".$fields['email']->input."</p>";
                                } else {
                                ?>
                                	<p><input type="text" value="<?php echo JFactory::getUser()->email?>" disabled id="email" name="email" class="form-control"></p>
                                <?php }?>
                                </div>
                                <div class="inner-addon right-addon">
                                <?php
