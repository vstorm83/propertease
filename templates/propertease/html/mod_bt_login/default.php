...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			?>
			<span id="btl-panel-login-y" class="<?php echo $effect;?>btn-login"><?php echo JText::_('JLOGIN');?></span>
			<?php }?>
			<!-- Registration button -->
			<?php
	...
	<div id="btl-content">
		...
		<div id="btl-content-login-y" class="btl-content-block">
			...
			<?php if($integrated_com==''|| $moduleRender == ''){?>
				...
				<div class="form-group">
				<p>By logging in, you agree to our <br/><a href="conditions-of-use.html#Privacy">Privacy Policy</a> and <a href="conditions-of-use.html">Terms of Use.</a></p>
				</div>
