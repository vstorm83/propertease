...
?>
 <!DOCTYPE html>  
 <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb" slick-uniqueid="3" dir="ltr" class="com_content view-article itemid-227 resource j34 mm-hover no-touch <?php if(intval($_GET['sr'])>0 || JSite::getMenu()->getActive()->alias == 'sample-reports'){ echo "reports"; } ?>" lang="en-gb"><head>  
...
<!--[if lt IE 9]>  
 ...
 <article itemscope="" itemtype="http://schema.org/Article">  
   ...
   <header class="article-header clearfix" id="submenu">
      <div class="container">
        <ul class="nav nav-tabs">
          ...
          if (($menu->getActive() == $menu->getDefault() and $status>0  and intval($_GET['sr'])>=0) || $menu->getActive()->alias == 'all-reports'
          	...
          	if (intval($_GET['sr']) == 0) {
            ?>
          <li class="<?php echo $menuTitle == 'Start' ? 'active' : ''?>" itemprop="name">
          ...
          ?>
          <li class="active"><i class="clock-icon"></i><a href=""><?php echo $reportName?></a></li>
          <?php 
          	}
          }
          ?>
          <li class="<?php echo $menuTitle == 'REPORT HISTORY' ? 'active' : ''?>">
          <?php if ($menu->getActive()->alias != 'start') {?>
          	<!-- <i class="clock-icon"></i>  -->
          <?php } ?>
...
if ($menu->getActive() == $menu->getDefault() and intval($_GET['sr'])==0) {
 ...
 <section class="article-content clearfix" itemprop="articleBody">  
        ...
        include_once('home_create_report.php'); //echo $content; ?>
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="row">
