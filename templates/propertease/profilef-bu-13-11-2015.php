		...
		$ht.='<table '.($simple?'cellspacing="0" cellpadding="6" border="0"':'').'>
            ...
            <tbody>
                ...
                <tr align="left" valign="middle">
                    ...
                    <td style="border-bottom:  2px solid #eaeaea;padding: 15px "  colspan="2">'.(empty($data['zone'])?'N/A':(profilef::hte($data['zone']))).'</td>
                </tr>
                <tr align="left" valign="middle">
            ...
            <tbody>
                <tr>
					...
					<br><br>
                        ...
                        '.(!empty($data['muddisclaimer'])?'<sup>3</sup> '.profilef::hte($data['muddisclaimer']).'<br>':'').'
