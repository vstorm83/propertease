...
?>
<!DOCTYPE html>
<html id="ls-global" dir="ltr" class="com_content view-featured itemid-101 home j34 mm-hover no-touch" lang="en-gb"><head>
...
<ul class="nav  nav-pills nav-stacked ">
    <li class="item-101 current active"><a class="home" href="<?php echo $mainURL; ?>">Home</a>
    </li>
    <li class="item-113 deeper dropdown"><a class="dropdown-toggle" href="<?php echo $mainURL; ?>subscribe.html" data-toggle="dropdown">Plans     <em class="caret"></em></a>
        <ul class="dropdown-menu">
            <li class="item-171"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-architects.html">Benefits for Architects</a>
            </li>
            <li class="item-172"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-builders.html">Benefits for Builders</a>
            </li>
            <li class="item-173"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-investors.html">Benefits for Investors</a>
            </li>
            <li class="item-174"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-town-planners.html">Benefits for Town Planners</a>
            </li>
            <li class="item-175"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-developers.html">Benefits for Developers</a>
            </li>
            <li class="item-176"><a href="<?php echo $mainURL; ?>benefits-to-you/benefits-for-real-estate-agents.html">Benefits for Real Estate Agents</a>
            </li>
            <li class="item-111"><a href="<?php echo $mainURL; ?>benefits-to-you/testimonials.html">Testimonials</a>
            </li>
            <li class="item-219"><a href="<?php echo $mainURL; ?>benefits-to-you/survey-win.html">Survey &amp; Win</a>
            </li>
        </ul>
    </li>
    <li class="item-112"><a href="<?php echo $mainURL; ?>sample-reports.html">Sample Reports</a>
    </li>
    <li class="item-169"><a href="<?php echo $mainURL; ?>resources.html">Resources</a>
    </li>
    <li class="item-114"><a class="Connect bold" href="<?php echo $mainURL; ?>faq.html" title="   ">Connect        </a>
    </li>
    <li class="item-233"><a href="<?php echo $mainURL; ?>popup.html">Popup</a>
    </li>
</ul>
