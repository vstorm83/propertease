/**
 * @version: $Id: tree.js 4387 2015-02-19 12:24:35Z Radek Suski $
...
var menuTree_stmWait = 'http://dev.dusted.com.au/propertease1910/media/sobipro/adm/spinner.gif';

menuTree_stmImgs[ 'root' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/base.gif';
menuTree_stmImgs[ 'join' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/join.gif';
menuTree_stmImgs[ 'joinBottom' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/joinbottom.gif';
menuTree_stmImgs[ 'plus' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/plus.gif';
menuTree_stmImgs[ 'plusBottom' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/plusbottom.gif';
menuTree_stmImgs[ 'minus' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/minus.gif';
menuTree_stmImgs[ 'minusBottom' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/minusbottom.gif';
menuTree_stmImgs[ 'folder' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/folder.gif';
menuTree_stmImgs[ 'disabled' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/disabled.gif';
menuTree_stmImgs[ 'folderOpen' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/folderopen.gif';
menuTree_stmImgs[ 'line' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/line.gif';
menuTree_stmImgs[ 'empty' ] = 'http://dev.dusted.com.au/propertease1910/media/sobipro/tree/empty.gif';;

menuTree_stmImgMatrix[ 1404 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid )
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=1298&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
...
function menuTree_stmAddSubcats( XMLDoc, deep, ccatid )
{
	...
	for( i = 0; i < categories.length; i++ ) {
		...
		subcats = subcats + "<div class='sigsiuTreeNode' id='menuTreestNode" + catid + "'>" + margin  + join + "<a id='menuTree" + catid + "' href=\"" + url + "\"><img src='" + menuTree_stmImgs[ 'folder' ] + "' id='menuTree_imgFolder" + catid + "' alt=''></a><a class='treeNode' rel=\""+ catid + "\" id='menuTree_CatUrl" + catid + "' href=\"" + url + "\">" + name + "</a></div>";
		if( childs > 0 ) {
