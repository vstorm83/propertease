...
<form id='newticket' action="<?php echo str_replace("&amp;","&",FSSRoute::x( '&what=forward=' ));?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-condensed">
...
{
	window.location.href = '<?php echo FSSRoute::_("index.php?option=com_fss&view=admin_support&ticketid=" . $this->ticket->id, false ); ?>';
}
