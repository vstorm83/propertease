			...
			<?php endif; ?>			
				...
				<?php if ($this->can_ChangeTicket() && $this->can_EditTicket()): ?>
					<div class="pull-right" style="margin-left: 6px;margin-right: 6px;">
						<a href='<?php echo FSSRoute::_( 'index.php?option=com_fss&view=admin_support&task=attach.delete&ticketid=' . $this->ticket->id . '&fileid=' . $attach->id ); ?>' title='Delete Attachment' class='fssTip'>
