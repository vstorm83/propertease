...
?>
		...
		<div class="control-group">
			<label class="control-label"><?php echo JText::_("NEW_HANDLER"); ?> - 
			<?php echo "!" . FSS_Settings::get('forward_product_handler') . "!"; ?></label>
			<div class="controls">
		...
		<!--<div class="control-group">
			<label class="control-label"><?php echo JText::_("ASSIGN_NEW_HANDLER"); ?></label>
			<div class="controls">
				<input type="checkbox" name="newhandler" value="1" checked="checked" />
			</div>
		</div>-->
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php echo SupportCanned::CannedDropdown("body2"); ?>
			</div>
		</div>
