...
?>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="handler" id="advanced_handler" class="select-color">
					...
					<optgroup label="<?php echo JText::_('QUICK'); ?>">
						<option value="-1" class="text-success" <?php if ($handlerid == -1) echo " SELECTED "; ?>><?php echo JText::_('MY_TICKETS'); ?></option>
						<option value="-2" class="text-info" <?php if ($handlerid == -2) echo " SELECTED "; ?>><?php echo JText::_('OTHER_HANDLERS_TICKETS'); ?></option>
						<option value="-3" class="text-warning" <?php if ($handlerid == -3) echo " SELECTED "; ?>><?php echo JText::_('UNASSIGNED'); ?></option>
						<option value="-4" class="text-info" <?php if ($handlerid == -4) echo " SELECTED "; ?>><?php echo JText::_('MY_CC_TICKETS'); ?></option>
						<option value="-5" class="text-success" <?php if ($handlerid == -5) echo " SELECTED "; ?>><?php echo JText::_('MY_ASSIGNED_TICKETS'); ?></option>
					</optgroup>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="status" id="advanced_status" class="select-color">
					<option value=""><?php echo JText::_("ALL_STATUSES") ?></option>		
					<optgroup label="<?php echo JText::_('STATUSS'); ?>">
						<?php $statusid = FSS_Input::getCmd('status'); ?>
						<?php foreach ($this->statuss as $status) :?>
							<option value="<?php echo $status->id ?>" <?php if ($statusid == $status->id) echo " SELECTED "; ?> style='color: <?php echo FSS_Helper::escape($status->color); ?>'><?php echo $status->title ?></option>
						<?php endforeach; ?>
					</optgroup>
					<optgroup label="<?php echo JText::_('GROUPS'); ?>">
						<option value="allopen" <?php if ($statusid == "allopen") echo " SELECTED "; ?>><?php echo JText::_('S_ALLOPEN'); ?></option>
						<option value="closed" <?php if ($statusid == "closed") echo " SELECTED "; ?>><?php echo JText::_('S_CLOSED'); ?></option>
						<option value="all" <?php if ($statusid == "all") echo " SELECTED "; ?>><?php echo JText::_('S_ALL'); ?></option>
					</optgroup>
				</select>				
			</td>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="product" id="advanced_product">
					...
					<?php $productid = FSS_Input::getInt('product'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="department" id="advanced_department">
					...
					<?php $departmentid = FSS_Input::getInt('department'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="cat" id="advanced_cat">
					...
					<?php $catid = FSS_Input::getInt('cat'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="priority" id="advanced_priority" class="select-color">
					<option value=""><?php echo JText::_("ALL_PRIORITIES") ?></option>		
					<?php $priorityid = FSS_Input::getInt('priority'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
				<select name="group" id="advanced_group">
					...
					<?php $groupid = FSS_Input::getInt('group'); ?>
