...
<div class="pull-right btn-group" style="margin-right: 8px; z-index: 10;">
	<a class="btn btn-default fssTip" title="Goto previous ticket of this status" href="<?php echo FSSRoute::x('task=navigate.prev&ticketid=' . $this->ticket->id, false); ?>"><?php echo JText::_('PREV'); ?></a>
	<a class="btn btn-default fssTip" title="Goto next ticket of this status" href="<?php echo FSSRoute::x('task=navigate.next&ticketid=' . $this->ticket->id, false); ?>"><?php echo JText::_('NEXT'); ?></a>
</div>
