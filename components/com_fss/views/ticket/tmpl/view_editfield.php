...
?>
	<form action="<?php echo FSSRoute::_("index.php?option=com_fss&view=ticket&tmpl=component&ticketid=" . FSS_Input::getInt('ticketid')); ?>" method="post" class="form-horizontal" id="fssForm">
