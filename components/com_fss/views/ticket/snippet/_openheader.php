...
<?php else: ?>
	...
	<?php  else: ?>
		...
		<div class="alert alert-info">
			<?php echo JText::sprintf("CREATE_UNREG",$this->email,FSSRoute::_( '&layout=open&what=reset' ));// FIX LINK ?>
		</div>
	
		<ul class="nav nav-tabs">
			<li class="active">
				<a class='ffs_tab fss_tab_selected' href='<?php echo FSSRoute::_( '&layout=open&limitstart=0' );// FIX LINK ?>'>
					<?php echo JText::_('OPEN_NEW_TICKET'); ?>
				</a>
			</li>
			<li>
				<a class='ffs_tab' href='<?php echo FSSRoute::_( '&what=find&layout=view' );// FIX LINK ?>'>
