...
<?php echo FSS_Helper::PageTitle("FREQUENTLY_ASKED_QUESTION"); ?>
	...
	<div class="media-body">
		...
		<?php if ($this->faq['featured']): ?>
			<div class="pull-right well well-xsmall">
				<img src="<?php echo JURI::root( true ); ?>/components/com_fss/assets/images/featuredfaq.png"	width="16" height="16" />
