...
<?php echo FSS_Helper::PageTitlePopup(JText::_("Add users to ticket group")); ?>
...
<?php endif; ?>
    ...
    <thead>
			...
			<th width="5">#</th>
            <th width="20">
   				<input type="checkbox" name="toggle" value="" id="checkall" onclick="checkAll(<?php echo count( $this->users ); ?>);" />
			</th>
