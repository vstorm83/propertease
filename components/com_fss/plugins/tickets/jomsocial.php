...
{
	var $title = "Jom Social Messaging Interface";
	var $description = "Post personal messages using Jom social when ticket actions occur. The messages posted are taken from the email templates.";
