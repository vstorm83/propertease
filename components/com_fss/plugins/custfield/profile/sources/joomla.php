...
class ProfileSourceJoomla extends ProfileSource
{
	...
	{
		return array(
			'address' => "{joomla.address1}<br />{joomla.address2}<br />{joomla.city}<br />{joomla.region}<br />{joomla.country}<br />{joomla.postal_code}",
			'addresstel' => "{joomla.address1}<br />{joomla.address2}<br />{joomla.city}<br />{joomla.region}<br />{joomla.country}<br />{joomla.postal_code}<br />{joomla.phone}"
			);
	}
